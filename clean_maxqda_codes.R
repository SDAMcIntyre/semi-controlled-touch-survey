...
touch_data_file <- "/Users/sarmc72/Library/CloudStorage/OneDrive-Linköpingsuniversitet/projects - in progress/semi-controlled social touch/online survey/analysis/Processed Data/touch_data.txt"
